...
from kecelakaan.submodule.scrapper.scrapper.spiders.news_spider import NewsSpider
import sys    
...
class ScrapProcess:
    ...
    def crawlNews(self) -> str:
        # try:
            self.process.crawl(NewsSpider, 'news') #ini masuk scrapnya
            # self.process.crawl() #ini kalo mau nambahin spider lain
            self.process.start()
