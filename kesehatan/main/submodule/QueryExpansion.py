...
class QueryExpansion:
    def __init__(self) -> None:
        ...
        self.tfidf_vectorizer = joblib.load('D:/sem9/program/TA_petakabar/kesehatan/main/dataset/qe/vectorizer.pkl')
        self.tfidf_matrix = joblib.load('D:/sem9/program/TA_petakabar/kesehatan/main/dataset/qe/tfidf_train.pkl')
        self.df_train = pd.read_csv('D:/sem9/program/TA_petakabar/kesehatan/main/dataset/qe/df_train.csv')

        df_bow_what = pd.read_csv('D:/sem9/program/TA_petakabar/kesehatan/main/dataset/qe/bow_what.csv')
        self.bow_list_what = []
